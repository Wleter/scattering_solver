...
//     potentials::{
//         coupled_potential::CoupledPotential, gaussian_coupling::GaussianCoupling, multi_coupling::MultiCoupling, multi_diag_potential::Diagonal, potential::Potential, potential_factory::create_lj
//     },
...
//     let potential = Diagonal::new([potential_lj1, potential_lj2]);
...
//     let potential = Diagonal::from_vec(vec![potential_lj1, potential_lj2]);
